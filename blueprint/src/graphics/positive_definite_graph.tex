...
\begin{document}
      \begin{tikzpicture}
        ...
        \if0
        % C_n
				\draw[double distance=3pt, postaction={decorate}] (1, -3) -- (2, -3);
				\foreach \i in {1,...,7}
					\node[circle, draw, fill=white, inner sep=1.5pt] (\i) at (\i,-3) {};
				\foreach \i in {2,...,4,6}
					\draw (\i) -- (\the\numexpr\i+1\relax);
        ...
        \foreach \i in {1,...,5}
				...
				\foreach \i in {1,...,4}
					\draw (\i) -- (\the\numexpr\i+1\relax);
				\draw (3) -- (8);
        \node[below] at (1) {$\alpha_6$};
        \node[right] at (8) {$\alpha_4$};
        \node[below] at (2) {$\alpha_5$};
        \node[below] at (3) {$\alpha_3$};
        ...
        \foreach \i in {1,...,6}
				...
				\foreach \i in {1,...,5}
					\draw (\i) -- (\the\numexpr\i+1\relax);
				\draw (3) -- (8);
        \node[below] at (1) {$\alpha_7$};
        \node[right] at (8) {$\alpha_5$};
        \node[below] at (2) {$\alpha_6$};
        \node[below] at (3) {$\alpha_4$};
        \node[below] at (4) {$\alpha_3$};
        \node[below] at (5) {$\alpha_2$};
        \node[below] at (6) {$\alpha_1$};
